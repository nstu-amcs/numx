...
\subsection{Линейное поле}

\subsubsection{Описание задачи}

\subsubsection{Оценка оптимального параметра релаксации}

\subsubsection{Сравнительный анализ методов решения}

\subsection{Полиномиальное поле}
...
\noindent
С помощью метода дихотомии, оценим 
