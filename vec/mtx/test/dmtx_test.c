...
static MunitResult test_dmtx_vmlt_asym(const MunitParameter pps[], void* ctx) {
  ...
  munit_assert_int(0, ==, mtx_new(&m, ((struct dmtx_pps){3, 3})));

  m.la[0] = 0;
  m.la[1] = 1;
  m.la[2] = -2;

  m.ad[0][0] = 1; m.ad[0][1] = 2; m.ad[0][2] = 0;
  m.ad[1][0] = 7; m.ad[1][1] = 3; m.ad[1][2] = 0;
  m.ad[2][0] = 0; m.ad[2][1] = 0; m.ad[2][2] = -1;
  ...
  munit_assert_double_equal(-1.0, f.dat[2], 15);
